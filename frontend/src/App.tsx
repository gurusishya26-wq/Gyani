...
const translations = {
  en: {
    ...
    dailyJobUpdates: "Daily Job Updates",
      ...
      <div className="p-8">
        {activeTab === 'login' ? (
          <div className="space-y-6">
            ...
            {/* Google Login */}
            <button className="w-full flex items-center justify-center gap-3 py-4 px-5 border border-gray-300 rounded-2xl font-semibold text-lg hover:bg-gray-50 transition-colors">
            ...
            <div className="space-y-4">
              ...
              <input
                ...
                className="w-full px-5 py-4 rounded-2xl border border-gray-300 focus:outline-none focus:border-[#5faae0] text-base"
              />
              <button className="w-full bg-[#5faae0] text-white py-4 rounded-2xl font-semibold text-lg hover:bg-[#4a9bd4] transition">
